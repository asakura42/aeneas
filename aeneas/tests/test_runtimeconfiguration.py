...
class TestRuntimeConfiguration(unittest.TestCase):
    ...
    def test_set_rconf_string(self):
        params = [
            ...
            ("tts=espeak-ng", "tts", "espeak-ng"),
            ("tts_path=/foo/bar/espeak-ng", "tts_path", "/foo/bar/espeak-ng"),
            ...
            ("tts_l1=espeak-ng", "tts_l1", "espeak-ng"),
            ("tts_path_l1=/foo/bar/espeak-ng", "tts_path_l1", "/foo/bar/espeak-ng"),
            ("tts_l2=espeak-ng", "tts_l2", "espeak-ng"),
            ("tts_path_l2=/foo/bar/espeak-ng", "tts_path_l2", "/foo/bar/espeak-ng"),
            ("tts_l3=espeak-ng", "tts_l3", "espeak-ng"),
            ("tts_path_l3=/foo/bar/espeak-ng", "tts_path_l3", "/foo/bar/espeak-ng"),
            (
